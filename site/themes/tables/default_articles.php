...
<tr>
	...
	<td class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?> seth_num">
	...
	?>
 	<td class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?> seth_title">
	...
	<td class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?> seth_cdate">
	...
	<td class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?> seth_mdate">
		<?php echo JHTML::_('grid.sort',  'UPDATED', 'modified', $this->lists['order_Dir'], $this->lists['order'] ); ?>
	</td>
	<?php endif; ?>
	<?php if ($this->params->get('se_show_author')==1) : ?>
	<td class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?> seth_author">
		<?php echo JHTML::_('grid.sort',  'AUTHOR', 'author', $this->lists['order_Dir'], $this->lists['order'] ); ?>
	</td>
	<?php endif; ?>
	<?php if ($this->params->get('se_show_voting') == 1 ) : ?>
	<td class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?> seth_vote">
	...
	<td class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?> seth_hits">
		<span style="white-space: nowrap;">
		      ...
		      <div class="seartoptnldata">
		          <?php if (($this->params->get('se_show_create_date')==2) || 
		              ...
		              <span class="createdate">	
							<?php if ($this->params->get('se_show_create_date')==2)
							{
								echo JText::_('CREATED') .": ". JHTML::_('date', $article->created, JText::_($tmformat)) . "<br />";
							} ?>
			                <?php if ($this->params->get('se_show_modify_date')==2) 
							{
			                    echo JText::_('UPDATED') .": ". JHTML::_('date', $article->modified, JText::_($tmformat)) ."<br />";
							} ?>
