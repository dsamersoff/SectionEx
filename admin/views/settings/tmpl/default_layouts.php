					...
					<table cellspacing="1" class="admintable">
						<tbody>
							...
							<tr>
								...
								<td valign="top">
									<input type="radio" value="0" id="paramsse_show_toc0" name="params[se_show_toc]" <?php echo ($this->params->get('se_show_toc', '1') == '0')?'checked="checked"':'';?> />
									<label for="paramsse_show_toc0">Hide</label>
									<input type="radio" value="1" id="paramsse_show_toc1" name="params[se_show_toc]" <?php echo ($this->params->get('se_show_toc', '1') == '1')?'checked="checked"':'';?> />
									<label for="paramsse_show_tocs1">Show</label>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="top">
									<input type="radio" value="0" id="paramsse_toc_show_numitems0" name="params[se_toc_show_numitems]" <?php echo ($this->params->get('se_toc_show_numitems', '1') == '0')?'checked="checked"':'';?> />
									<label for="paramsse_toc_show_numitems0">Hide</label>
									<input type="radio" value="1" id="paramsse_toc_show_numitems1" name="params[se_toc_show_numitems]" <?php echo ($this->params->get('se_toc_show_numitems', '1') == '1')?'checked="checked"':'';?> />
									<label for="paramsse_toc_show_numitems1">Show</label>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="top">
									<input type="radio" value="0" id="paramsse_show_table_headings0" name="params[se_show_table_headings]" <?php echo ($this->params->get('se_show_table_headings', '1') == '0')?'checked="checked"':'';?> />
									<label for="paramsse_show_table_headings0">Hide</label>
									<input type="radio" value="1" id="paramsse_show_table_headings1" name="params[se_show_table_headings]" <?php echo ($this->params->get('se_show_table_headings', '1') == '1')?'checked="checked"':'';?> />
									<label for="paramsse_show_table_headings1">Show</label>
								</td>
							</tr>
