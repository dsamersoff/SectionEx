					...
					<table cellspacing="1" class="admintable">
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="radio" value="0" id="paramsse_show_article_num0" name="params[se_show_article_num]" <?php echo ($this->params->get('se_show_article_num', '1') == '0')?'checked="checked"':'';?> />
									<label for="paramsse_show_article_num0">Hide</label>
									<input type="radio" value="1" id="paramsse_show_article_num1" name="params[se_show_article_num]" <?php echo ($this->params->get('se_show_article_num', '1') == '1')?'checked="checked"':'';?> />
									<label for="paramsse_show_article_num1">Show</label>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="top">
									<input type="radio" value="0" id="paramsse_show_article_title0" name="params[se_show_article_title]" <?php echo ($this->params->get('se_show_article_title', '1') == '0')?'checked="checked"':'';?> />
									<label for="paramsse_show_article_title0">Hide</label>
									<input type="radio" value="1" id="paramsse_show_article_title1" name="params[se_show_article_title]" <?php echo ($this->params->get('se_show_article_title', '1') == '1')?'checked="checked"':'';?> />
									<label for="paramsse_show_article_title1">Show</label>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="top">
									<input type="radio" value="0" id="paramsse_show_voting0" name="params[se_show_voting]" <?php echo ($this->params->get('se_show_voting', '0') == '0')?'checked="checked"':'';?> />
									<label for="paramsse_show_voting0">Hide</label>
									<input type="radio" value="1" id="paramsse_show_voting1" name="params[se_show_voting]" <?php echo ($this->params->get('se_show_voting', '0') == '1')?'checked="checked"':'';?> />
									<label for="paramsse_show_voting1">Show as table column</label>
									<input type="radio" value="2" id="paramsse_show_voting2" name="params[se_show_voting]" <?php echo ($this->params->get('se_show_voting', '0') == '2')?'checked="checked"':'';?> />
									<label for="paramsse_show_voting2">Show as comment</label>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="top">
									<input type="radio" checked="checked" value="0" id="paramsse_show_voting_count0" name="params[se_show_voting_count]" <?php echo ($this->params->get('se_show_voting_count', '0') == '0')?'checked="checked"':'';?> />
									<label for="paramsse_show_voting_count0">Hide</label>
									<input type="radio" value="1" id="paramsse_show_voting_count1" name="params[se_show_voting_count]" <?php echo ($this->params->get('se_show_voting_count', '0') == '1')?'checked="checked"':'';?> />
									<label for="paramsse_show_voting_count1">Show</label>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="top">
									<input type="radio" value="0" id="paramsse_images_in_intro_text0" name="params[se_images_in_intro_text]" <?php echo ($this->params->get('se_images_in_intro_text', '0') == '0')?'checked="checked"':'';?> />
									<label for="paramsse_images_in_intro_text0">Hide</label>
									<input type="radio" value="1" id="paramsse_images_in_intro_text1" name="params[se_images_in_intro_text]" <?php echo ($this->params->get('se_images_in_intro_text', '0') == '1')?'checked="checked"':'';?> />
									<label for="paramsse_images_in_intro_text1">Show</label>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="top">
									<input type="radio" value="0" id="paramsse_show_rss0" name="params[se_show_rss]" <?php echo ($this->params->get('se_show_rss', '1') == '0')?'checked="checked"':'';?> />
									<label for="paramsse_show_rss0"><?php echo JText::_('HIDE');?></label>
									<input type="radio" value="1" id="paramsse_show_rss1" name="params[se_show_rss]" <?php echo ($this->params->get('se_show_rss', '1') == '1')?'checked="checked"':'';?> />
									<label for="paramsse_show_rss1"><?php echo JText::_('SHOW');?></label>
								</td>
							</tr>														
