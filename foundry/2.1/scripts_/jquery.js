 ...
 *
 * Date: Wed Aug 07 2013 17:04:16 GMT+0800 (MYT)
 */
...
if (!dispatch) {
	...
	try {
		console.error("Unable to dispatch jQuery/1.8.2 to Foundry/2.1 Bootstrap.");
	} catch(e) {}

} else {

	dispatch("jQuery/1.8.2")
		.containing(jQuery)
		.onlyTo("Foundry/2.1 Bootstrap");
}
